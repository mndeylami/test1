 ...
 */
export declare type EvaluateFn = string | ((...args: any[]) => any);
/**
 ...
 */
export declare type Locatable = Locator | ElementHandle | string;
/**
 ...
 */
export declare type NullableLocatable = Locatable | null;
/**
...
export interface SuiteDefinition {
    ...
    withData<T>(data: TestDataSource<T>, callback: (this: null, step: StepDefinition<T>) => void): void;
}
/**
 ...
 */
export declare type Driver = Browser;
