 ...
 * @docPage TestData
 */
export declare const TestData: NullTestDataLoaders;
/**
 * @docPage Settings
 */
export { TestSettings, setup, DEFAULT_SETTINGS, ConsoleMethod, ResponseTiming, } from './src/runtime/Settings';
/**
 * @docPage DSL
 */
export { FloodProcessEnv } from './src/runtime-environment/types';
import { FloodProcessEnv } from './src/runtime-environment/types';
/**
 * A subset of `process.env` available to this test. It is of type <[FloodProcessEnv]>.
 * @docPage DSL
 */
export declare const ENV: FloodProcessEnv;
/**
 * @docPage Browser
 */
 ...
 * @docPage Browser
 */
export { ClickOptions, ScreenshotOptions, NavigationOptions, BoundingBox, LoadEvent, } from 'puppeteer';
/**
 * @docPage DSL
 */
