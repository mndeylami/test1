...
const username = "mig-test@tryelasticarpedge.com"
...
export default () => {
	step('Test: Start', async browser => {
		...
		await browser.wait(Until.elementIsVisible(By.visibleText('Stay signed in?')))
		await browser.takeScreenshot()
		//setTimeout(function(){console.log("Waiting for 10 seconds")}, 1000000);
		await browser.click(By.xpath('//input[@value="Yes"]'))
		//await browser.click(By.xpath('/html/body/div/form/div[1]/div/div[1]/div[2]/div/div[2]/div/div[3]/div[2]/div/div/div[2]'))
		await browser.wait(Until.elementIsVisible(By.visibleText('Office 365')))
		await browser.takeScreenshot()
		await browser.click(By.xpath('//div[2]/ohp-app-tile/div/a/span/ohp-icon-font/span'))
		await browser.switchTo()
		await browser.wait(Until.elementIsVisible(By.css('div.fgid_151627')))
		await browser.takeScreenshot()
		//await browser.wait(Until.elementIsVisible(By.visibleText('Files')))
		await browser.click(By.css('//div[2]/button/div/div/div'))
		await browser.click(By.css('//li/button/div/span'))
		//await browser.click(By.xpath('/html/body/div/form/div[1]/div/div[1]/div[2]/div/div[2]/div/div[3]/div[2]/div/div/div[2]'))
		//await browser.click(By.visibleText('Yes'))
		//await browser.click(By.attr('fgid', '236'))
		//await browser.sendKeys("Enter")
		//await browser.click(By.xpath('/html/body/div/form/div[1]/div'))
		//await browser.wait(Until.elementIsVisible(By.id('44116')))	
		//await browser.wait(Until.titleIs('Microsoft Office Home'))	
		/*
		let stay_signed_in = null
		try {
			stay_signed_in = await browser.findElement(By.visibleText('Stay signed in?'))
			await browser.takeScreenshot()		
		} catch {
		}
		if (stay_signed_in)
		{
			...
			await browser.click(By.xpath('/html/body/div/form/div[1]/div'))	
			await browser.wait(Until.elementIsVisible(By.xpath('//*[@id="officeHome"]')))		
		}
